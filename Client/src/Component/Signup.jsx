...
const Signup = () => {
  ...
  return (
    <main className='main' style={{backgroundImage: `url(https://media.istockphoto.com/id/147556876/photo/black-sports-car.jpg?s=612x612&w=0&k=20&c=mj98ULO7bJDdyyH3TwWIukdy2KncIQZW_HEP8bAb_Q4=)`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
